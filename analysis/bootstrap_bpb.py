...
Usage:
    # Single file
    python analysis/bootstrap_bpb.py eval_results/me340M-tied_bpe-128k_7Btok_seed42/bpb.parquet

    # All models under a directory (one row per bpb.parquet found)
    python analysis/bootstrap_bpb.py eval_results --glob "*/bpb.parquet" -o bpb_ci.parquet
"""
