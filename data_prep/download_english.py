...
def build_base_2b(output_dir: Path, tokenizer, min_tokens: int, revision: str) -> int:
    ...
    """
    dataset = load_dataset("HuggingFaceFW/fineweb-edu", split="train", streaming=True, revision=revision)
...
def main(
    ...
    if base_marker.exists() and (output_dir / "test").exists():
        ...
        base_stream_pos = build_base_2b(output_dir, tokenizer, min_tokens, revision)
